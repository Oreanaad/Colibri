...
const categoriasDeDescubrir =
    <String, List<(String, String, String?, int?, int?, int?)>>{
      ...
      'spanish_american_literature': [
        ...
        (
          'Escritores representativos de América',
      ...
      'literatura_argentina': [
        ...
        (
          'Historia Critica de la Literatura Argentina',
          'Noe Jitrik',
          '/works/OL5647346W',
          5229547,
          1999,
      ...
      'fan_fiction': [
        ...
        (
          'Beakman\'s World/Castelo Ra Tim Bum',
          '"Teary Eyes" Anderson',
          '/works/OL24207525W',
          10653344,
          2020,
